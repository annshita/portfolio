...
export const Projects = () => (
  <section id="projects" data-testid="projects-section" className="bg-blush-100/40 py-28 md:py-40">
    <div className="mx-auto max-w-7xl px-6 md:px-12">
      ...
      <div className="space-y-6">
        {PROJECTS.map((p, i) => (
          <motion.div
            key={p.title} custom={i} variants={reveal} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }}
      ...
      <motion.div variants={reveal} initial="hidden" whileInView="visible" viewport={{ once: true }} className="mt-24">
        <h3 className="mb-10 font-serif text-3xl italic text-plum">Honours & achievements</h3>
        <div className="grid gap-5 md:grid-cols-2">
          {ACHIEVEMENTS.map((a, i) => (
            <motion.div
              key={i} custom={i} variants={reveal} initial="hidden" whileInView="visible" viewport={{ once: true }}
