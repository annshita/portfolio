...
export const Skills = () => (
  <section id="skills" data-testid="skills-section" className="mx-auto max-w-7xl px-6 py-28 md:px-12 md:py-40">
    <motion.div variants={reveal} initial="hidden" whileInView="visible" viewport={{ once: true }} className="mb-16 flex items-end justify-between">
      <div>
    ...
    <div className="grid gap-6 md:grid-cols-12">
      ...
      <motion.div variants={reveal} custom={2} initial="hidden" whileInView="visible" viewport={{ once: true }}
        ...
        <div className="flex flex-wrap gap-3">
          {SKILLS.focus.map((s, i) => (
            <motion.span key={s} custom={i} variants={reveal} initial="hidden" whileInView="visible" viewport={{ once: true }}
