...
export const Hero = () => {
  ...
  return (
    <section ref={ref} className="relative flex min-h-screen items-center overflow-hidden pt-24">
      <motion.div style={{ y, scale }} className="pointer-events-none absolute -right-24 top-10 h-[70vh] w-[70vh] md:right-0">
      ...
      <div className="pointer-events-none absolute -left-40 bottom-0 h-96 w-96 rounded-full bg-blush-200/40 blur-3xl" />
      ...
      <motion.div style={{ opacity: fade }} className="relative z-10 mx-auto w-full max-w-7xl px-6 md:px-12">
        ...
        <h1 data-testid="hero-name" className="font-serif text-[18vw] leading-[0.85] text-plum md:text-[13vw] lg:text-[11rem]">
